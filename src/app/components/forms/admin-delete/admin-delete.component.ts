...
@Component({
  ...
  template: `
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-outline-danger" (click)="handleDelete()">Yes</button>
		</div>
  `,
})
export class NgbdModalContent {
  ...
  constructor(private bookService:BookService, private tokenService:TokenService){}
  ...
  handleDelete(){
    ...
    if(this.type==="Book"){
      console.log(true);
       this.bookService.deleteBook(this.item._id, this.token).subscribe(()=>this.bookService.updateBooks());
    }
  }
